#!/usr/bin/env python3
"""
🌙 Enhanced Yahoo Finance Historical Data Fetcher - HBAR Data 🚀
Fetches maximum years of HBAR historical data with proper OHLCV format for Bobby's backtesting framework
...
# ====== Configuration ======
TICKER = 'HBAR-USD'           # Yahoo Finance ticker symbol for Hedera
...
def validate_data_quality(df: pd.DataFrame) -> Dict:
    ...
    # For crypto (HBAR trades 365 days)
...
def main():
    ...
    print("🚀 Enhanced Yahoo Finance Historical Data Fetcher - HBAR Backtesting.py Compatible")
    print("=" * 70)
...
if __name__ == "__main__":
    data = main()
    if data is not None:
        print("\n✨ Enhanced HBAR data fetching complete! Ready for backtesting.py 🚀")