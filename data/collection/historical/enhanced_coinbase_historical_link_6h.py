#!/usr/bin/env python3
"""
🌙 Enhanced Coinbase Historical Data Fetcher - LINK 6-Hour Data 🚀
Fetches maximum weeks of LINK 6-hour data with exact BTCUSD format compatibility
Compatible with backtesting.py and multi-data testing patterns
Optimized for 6-hour intervals with extended historical coverage
"""
...
# 🔧 OPTIMIZED FOR LINK 6-HOUR DATA COLLECTION:

SYMBOL = 'LINK-USD'       # Trading pair for Chainlink
TIMEFRAME = '6h'          # 6-hour intervals for medium-term analysis
WEEKS = 200              # Maximum weeks for 6-hour data without hitting limits
SAVE_DIR = 'data/coinbase'  # Directory to save files

print("🌙 BobbyYo's Enhanced Coinbase Data Fetcher - LINK 6-Hour Data! 🚀")
...
def get_enhanced_coinbase_data(symbol, timeframe, weeks):
    ...
    try:
        ...
        while current_start < end_time:
            ...
            # Progressive delay for 6-hour data
        ...
        for candle in all_candles:
            ...
            # Format datetime for 6-hour intervals (include time)
...
if not data.empty:
    ...
    print(f"\n✨ Success! Enhanced {SYMBOL} 6-hour data is now available!")
