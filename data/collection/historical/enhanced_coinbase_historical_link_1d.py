#!/usr/bin/env python3
"""
🌙 Enhanced Coinbase Historical Data Fetcher - LINK Daily Data 🚀
Fetches maximum weeks of LINK daily data with exact BTCUSD format compatibility
Compatible with backtesting.py and multi-data testing patterns
Optimized for daily intervals with maximum historical coverage
"""
...
# 🔧 OPTIMIZED FOR LINK 1-DAY DATA COLLECTION:

SYMBOL = 'LINK-USD'       # Trading pair for Chainlink
TIMEFRAME = '1d'          # Daily intervals for long-term analysis
WEEKS = 1000             # Maximum weeks for daily data (19+ years)
SAVE_DIR = 'data/coinbase'  # Directory to save files

print("🌙 BobbyYo's Enhanced Coinbase Data Fetcher - LINK Daily Data! 🚀")
...
def get_enhanced_coinbase_data(symbol, timeframe, weeks):
    ...
    try:
        ...
        while current_start < end_time:
            ...
            # Progressive delay for daily data
        ...
        for candle in all_candles:
            ...
            # Format datetime for daily data (date only)
...
if not data.empty:
    ...
    print(f"\n✨ Success! Enhanced {SYMBOL} daily data is now available!")
