#!/usr/bin/env python3
"""
🌙 Enhanced Yahoo Finance Historical Data Fetcher - CRO Data 🚀
Fetches maximum years of CRO historical data with proper OHLCV format for Bobby's backtesting framework
...
# ====== Configuration ======
TICKER = 'CRO-USD'            # Yahoo Finance ticker symbol for Cronos
...
def validate_data_quality(df: pd.DataFrame) -> Dict:
    ...
    # For crypto (CRO trades 365 days)
...
def main():
    ...
    print("🚀 Enhanced Yahoo Finance Historical Data Fetcher - CRO Backtesting.py Compatible")
    print("=" * 70)
...
if __name__ == "__main__":
    data = main()
    if data is not None:
        print("\n✨ Enhanced CRO data fetching complete! Ready for backtesting.py 🚀")